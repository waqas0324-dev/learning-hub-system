...
function ImageCarousel() {
  ...
  const slides = [
    ...
    { src: 'https://upload.wikimedia.org/wikipedia/commons/4/4a/Mercury_in_true_color.jpg', captionEn: 'Mercury in true color — MESSENGER 2008', captionUr: 'عطارد اصلی رنگ میں — میسنجر 2008', credit: 'NASA/JHU APL/ASU (Public Domain)', gradient: 'radial-gradient(circle at 35% 35%, #b8a898, #8c7e6d 40%, #3d352c)' },
    ...
    { src: 'https://upload.wikimedia.org/wikipedia/commons/7/76/Mars_Hubble.jpg', captionEn: 'Mars as seen by Hubble Space Telescope', captionUr: 'ہبل خلائی دوربین سے نظر آنے والا مریخ', credit: 'NASA/Hubble Heritage Team (Public Domain)', gradient: 'radial-gradient(circle at 35% 35%, #e8845a, #c1440e 40%, #5c1800)' },
