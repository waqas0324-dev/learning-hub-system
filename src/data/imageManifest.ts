...
export const celestialImages: Record<string, CelestialImage> = {
  sun: {
    ...
    thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Sun_from_Space.jpg/400px-Sun_from_Space.jpg',
  ...
  mercury: {
    ...
    thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Mercury_in_true_color.jpg/400px-Mercury_in_true_color.jpg',
  ...
  venus: {
    ...
    thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Venus_from_Mariner_10.jpg/400px-Venus_from_Mariner_10.jpg',
  ...
  earth: {
    ...
    thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/The_Blue_Marble_%28reprocessed%29.jpg/400px-The_Blue_Marble_%28reprocessed%29.jpg',
  ...
  mars: {
    ...
    thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Mars_Hubble.jpg/400px-Mars_Hubble.jpg',
  ...
  jupiter: {
    ...
    thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Jupiter_and_its_shrunken_Great_Red_Spot.jpg/400px-Jupiter_and_its_shrunken_Great_Red_Spot.jpg',
  ...
  uranus: {
    ...
    thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Uranus_as_seen_by_Voyager_2.png/400px-Uranus_as_seen_by_Voyager_2.png',
  ...
  neptune: {
    ...
    thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Neptune_-_Voyager_2_%2829347980847%29_flatten_clarity.jpg/400px-Neptune_-_Voyager_2_%2829347980847%29_flatten_clarity.jpg',
